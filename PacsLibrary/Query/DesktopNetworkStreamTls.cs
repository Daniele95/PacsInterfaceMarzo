...
namespace PacsLibrary.Query
{
    ...
    /// </summary>
    public sealed class DesktopNetworkStreamTls : INetworkStream
    {
        #region FIELDS
        ...
        /// <summary>
        /// Initializes a client instance of <see cref="DesktopNetworkStreamTls"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a server instance of <see cref="DesktopNetworkStreamTls"/>.
        /// </summary>
        ...
        /// disposal. Therefore, a handle to <paramref name="tcpClient"/> is <em>not</em> stored when <see cref="DesktopNetworkStreamTls"/>
        /// is initialized with this server-side constructor.</remarks>
        internal DesktopNetworkStreamTls(TcpClient tcpClient, X509Certificate certificate)
        {
            this.LocalHost = ((IPEndPoint)tcpClient.Client.LocalEndPoint).Address.ToString();
            this.LocalPort = ((IPEndPoint)tcpClient.Client.LocalEndPoint).Port;
